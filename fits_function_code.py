#author: nicktasker at https://github.com/EoRImaging/uwchamp2017
# coding: utf-8
...
###
#astropy.convolution: provides convolution functions and kernels that offer improvements compared 
#to the SciPy scipy.ndimage convolution routines, including:
...
# Both direct [convolve()] and Fast Fourier Transform (FFT) versions
# [convolve_fft()]
...
#astropy.wcs: contains utilities for managing World Coordinate System (WCS) transformations 
#in FITS files. These transformations map the pixel locations in an image to 
#their real-world units, such as their position on the sky sphere.
from astropy.wcs import WCS

#FITS (Flexible Image Transport System): a portable file standard widely 
#used in the astronomy community to store images and tables.
from astropy.io import fits

#units: handles defining, converting between, and performing arithmetic with 
#physical quantities, such as meters, seconds, Hz, etc. It also handles logarithmic 
#units such as magnitude and decibel.
